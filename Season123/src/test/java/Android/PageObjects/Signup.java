...
public class Signup {
	...
	//"//android.widget.EditText[@content-desc=\"search-input-input\"]"
	@FindBy(xpath= "//android.widget.EditText[@content-desc=\"search-input-input\"]")
	public WebElement enterLocation;
	
	@FindBy(xpath = "(//android.widget.TextView[@content-desc=\"onboarding-location-google-autocomplete-text-highlight-text\"])[1]")
	public WebElement slect;
	...
	////android.widget.Button[@content-desc=\"ContentFeed, tab, 1 of 4\"]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup
	@FindBy(xpath= "//android.widget.Button[@content-desc=\"ContentFeed, tab, 1 of 4\"]")
