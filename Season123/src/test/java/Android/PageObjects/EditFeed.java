...
public class EditFeed {
	...
	@FindBy(xpath = "//android.view.ViewGroup[@content-desc=\"station-message-1-station-message-station-message-head-menu-icon-button\"]")
	...
	////android.view.ViewGroup[@content-desc=\"station-message-2-station-message-station-message-head-menu-icon-button\"]/android.view.ViewGroup/android.view.ViewGroup
	@FindBy(xpath = "(//android.view.ViewGroup[@content-desc=\"station-message-1-station-message-station-message-head-menu-icon-button\"])[2]")
	public WebElement ellipsisreply;
	
	@FindBy(xpath = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.widget.FrameLayout/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[2]/android.view.ViewGroup/android.view.ViewGroup/android.view.ViewGroup[1]/android.widget.ScrollView/android.view.ViewGroup/android.view.ViewGroup[3]")
	public WebElement ReplyBlock;
	...
	////android.view.ViewGroup[@content-desc=\"header-avatar-avatar-empty-image\"]/android.view.ViewGroup/android.view.ViewGroup
	@FindBy(xpath= "//android.view.ViewGroup[@content-desc=\"header-avatar-avatar-0-empty-image\"]")
	...
	//(//android.widget.TextView[@content-desc=\"list-item-label\"])[8]
	@FindBy(xpath= "(//android.widget.TextView[@content-desc=\"list-item-label\"])[7]")
